 ...
 if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    print_r("Este é o ID do produto:".$id."<br>Nome do produto: ".$nome_produto."<br>Marca do produto: ".$marca_produto."<br>Valor do produto: ".$valor_pago."<br>Valor de revenda:".$valor_revenda."<br>Lucro do produto;".$lucro_produto);
