...
<html>
  ...
  <body>
    ...
    <nav class="container">
      ...
      <button><a type="button" class="btn btn-outline-dark" href="../pages/estoque.php">Estoque</a></button>
      ...
      <button><a type="button" class="btn btn-outline-dark" href="../pages/controle_estoque.php">Controle de Estoque</a></button>
